...
const GraphSectionHead = () => {
  return (
    <div className='grid items-center w-full grid-cols-4 pl-8 pr-4'>
        ...
        <div className='flex items-center justify-center col-span-2 space-x-2 text-right'>
            ...
            <button className='border border-[#BFDBFE] rounded bg-[#F4F8FD] w-7 h-7'><SlPencil /></button>
