...
const Frame54Card = ({ demo }: {demo?: boolean}) => {
  return (
    <div className='relative flex flex-col items-center justify-between pt-5 space-y-6 px-7 max-w-[410px] border-2 rounded-xl'>
        <div className='flex flex-col items-start justify-between space-y-2'>
            <h2 className='text-2xl font-bold'>10000.00 USD</h2>
            <p className='text-xs'>Account:  256033, Match-Trader Demo</p>
        </div>
        <div className='flex flex-row items-center justify-center w-full space-x-2 xs:space-x-4'>
