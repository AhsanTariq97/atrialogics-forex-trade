...
const NavAccountData = () => {
  return (
    <div className='flex items-center justify-end md:justify-center lg:bg-[#FFFFF4] md:border-l border-r border-[#D9D9D9] col-span-2 md:col-span-1 lg:col-span-2 py-1'>
        ...
        <Link href='/frame54'><button className='lg:hidden bg-[#2F80ED] text-white font-semibold px-2 py-2 sm:px-3 sm:py-3 rounded min-w-max text-sm sm:text-base'>OPEN LIVE ACCOUNT</button></Link>
