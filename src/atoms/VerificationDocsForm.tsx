...
const VerificationDocsForm = ({ errors, control, setValue, register, isFormSubmitted, setIsFormSubmitted }: { errors: any, control: any, setValue: any, register: any, isFormSubmitted: boolean, setIsFormSubmitted: any }) => {
