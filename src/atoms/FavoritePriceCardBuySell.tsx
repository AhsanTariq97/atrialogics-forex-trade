  ...
  return (
    <div className='border border-[#D9D9D9] rounded px-4 py-1 space-y-2'>
      <div className='grid w-full grid-cols-5'>
          ...
          <div className='flex items-center justify-between col-span-2 space-x-2 text-center'>
      ...
      <div className='grid grid-cols-3 space-x-2'>
        <button className='bg-[#EF4444] border border-[#EF4444] rounded text-white text-[10px] font-medium text-left px-4 py-2'>SELL <br /><span className='text-xl'>1.08386</span></button>
        ...
        <button className='bg-[#10B981] border border-[#10B981] rounded text-white text-[10px] font-medium text-right px-4 py-2'>BUY <br /><span className='text-xl'>1.08387</span></button>
      </div>
    </div>
  )
}
